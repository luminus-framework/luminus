...
(defn home []
  (cache
    :home (common/layout-home
            "Home" (util/md->html "intro.md")
            [:div#footer-outer.clear
             [:div#footer-wrap
              [:h2 "Why Luminus?"]
              [:div.col-a (feature-item "Rapid development" "No boilerplate, no nonsense, get your work done framework")
               (feature-item "Productivity" "The performance of the JVM combined with the power of Clojure")]
              [:div.col-a (feature-item "Interactivity" "Interactive development with full REPL integration")
               (feature-item "Flexibility" "Choose the components which make sense for you")]
              [:div.col-b (feature-item "Mature ecosystem" "Access to the plethora of existing Clojure and Java libraries")
